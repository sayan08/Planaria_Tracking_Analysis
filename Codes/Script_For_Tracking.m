...
% Update the directory from where to read the files; threshold Array
clear all
close all
moth_dirt = 'C:\User_Me\Virtual_Drives\E\Brandeis\Summer_01\Github_Tracking\Cd\Copy_of_Data\';
